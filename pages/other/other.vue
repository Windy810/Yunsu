			...
			<swiper-item v-for="(listItem,listIndex) in list" :key="listIndex">
				...
				<view class='content'>
					<view v-if="listIndex == 0">		
						<image mode="widthFix" class="pic" src="../../static/baby/fushi1.jpg"></image>					
					</view>
					<view v-if="listIndex == 1">
						我是轮播图
						<swiper style="height: 30vh;width: 100vw;">
							<swiper-item v-for="(item,inde) in 3" :key="inde">
								<image style="height: 100%;width:100%;" src="../../static/baby/baby1.jpg"></image>
							</swiper-item>
						</swiper>
						<image mode="widthFix" class="pic" src="../../static/baby/yunqi.jpg"></image>
					</view>
					<view v-if="listIndex == 2">
						<image mode="widthFix" class="pic" src="../../static/baby/yimiao.jpg"></image>
					</view>
					<view v-if="listIndex == 3">
						<image mode="widthFix" class="pic" src="../../static/baby/yunqi.jpg"></image>
					</view>
					<view v-if="listIndex == 4">
						<image mode="widthFix" class="pic" src="../../static/baby/chanjian.jpg"></image>
					</view>
...
export default {
	...
	data() {
		return {
			...
			isX:0,//放在store统一管理
			isY:999,//放在store统一管理
			tabTitle:['辅食大全','孕育周刊','疫苗时间','看懂b超单','产检时间'], //导航栏格式 --导航栏组件
			currentTab: 0, //sweiper所在页
			pages:[1,1,1,1,1], //第几个swiper的第几页
			list: [["4-5个月\n现阶段，宝宝的胃肠道等消化器官还在发育中，如果妈妈过早给宝宝添加母乳以外的其他食物可能会出现消化不良、甚至食物过敏的问题。挺舌反应逐渐结束、宝宝即将开始长牙，为即将到来的辅食阶段做好前期准备。",
			 "6～7个月\n1、辅食添加没有规定顺序，从6个月开始添加辅食时，就要开始加肉、菜、谷物、水果，食物的丰富程度非常重要",
			  3, 4, 5, 6],['a', 'b', 'c', 'd', 'e', 'f'],[],['2233','4234','13144','324244'],[]] //数据格式
		};
	},
	onLoad(e) {
...
<style lang="scss">
	...
	.nav {
		...
		font-size: 24upx;
		background-color: rgb(147, 202, 118);
		z-index: 996;
	}
