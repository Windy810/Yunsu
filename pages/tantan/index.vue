					...
					let dataGroup = [								
								{
									...
									name:'天顺农场',
									address:'哈尔滨(70km)\n设有 “南果园”“红掌园”“现代化温室”“加工配送中心”“蔬菜种植区”等参观区，可为顾客展示现代化的节水灌溉设备、自动控温控湿设备、阳台无土种植设备、自动分选包装设备、洁净工厂栽培技术、生物防治技术等',
									constellation:'玉米地',
									number:10,
									old:5,
									src:"../../static/4.jpg"
								},
								{
									sex:Math.round(Math.random()),
									name:'闫家岗农场',
									address:'哈尔滨(9km)  闫家岗农场投资建设了占地350亩,集观光采摘、农耕体验、蔬菜宅配、科普教育、餐饮住宿于一体的“安心农场”',
									constellation:'小麦地',
									number:10,
									old:5,
									src:"../../static/1.jpg"
								},
								{
									sex:Math.round(Math.random()),
									name:'田鑫农场',
									address:'哈尔滨(50km)   “道里区新发镇建国村田鑫农场”最早始建于2006年春季,于2013年5月20日注册,注册资金500万。通过逐年的发展壮大,现农场总面积已达3405亩。',
									constellation:'草莓园',
									number:10,
									old:5,
									src:"../../static/5.jpg"
